...
class OnlineRepair:
    ...
    def online_repair_callback(self, msg) -> None:
        """Perform online repair for a given terrain state specified in msg
        """
        terrain_state: dict = self._get_terrain_state_from_msg(msg)
    ...
    def _get_terrain_state_from_msg(self, msg) -> dict:
        """Get terrain state from msg
        """
