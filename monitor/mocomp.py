...
# =============== Transform ASTs with integer inputs to ASTs with boolean inputs only =============== #
    ...
    def update_terrain_vars_dir(self, opts: dict) -> None:
        """Update the terrain inputs kept dict"""
        opts["up_terrain_vars"] = self._get_keyword_inputs("up") + self._get_keyword_inputs("current")
        opts["down_terrain_vars"] = self._get_keyword_inputs("down") + self._get_keyword_inputs("current")
        opts["left_terrain_vars"] = self._get_keyword_inputs("left") + self._get_keyword_inputs("current")
