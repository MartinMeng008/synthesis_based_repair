    ...
    for seed in range(args.n_seeds):
        ...
        while not is_realizable:
            ...
            for idx, suggestion in suggestions.items():
                ...
                skill = skills[suggestion['name']]
                print(skill.init_pres)
                print(skill.intermediate_states)
                print(skill.final_posts)
                # skill.print_dicts()
            print("----------------------------------")
            print("----------------------------------")
            print("Finish one iteration in the while loop")
            print("skills", skills.keys())
            print("----------------------------------")
            print("----------------------------------")
